...
def fun_with_ids
  ...
  puts "b_outer is #{b_outer} with an id of: #{b_outer_id} before the block."# "forty two" -- 2152729580 how can I predict so long id? I may misunerstood the ex..
  ...
  1.times do
    ...
    puts "a_outer id was #{a_outer_id} before the block and is: #{a_outer.object_id} inside the block."#85 -- 85
    puts "b_outer id was #{b_outer_id} before the block and is: #{b_outer.object_id} inside the block."#2152729580 -- 2152729580
    puts "c_outer id was #{c_outer_id} before the block and is: #{c_outer.object_id} inside the block."#2152729540 -- 2152729540
    ...
    puts "b_outer inside after reassignment is #{b_outer} with an id of: #{b_outer_id} before and: #{b_outer.object_id} after."#thirty three - 2152729558 - 2152728320
    ...
    puts "d_outer inside after reassignment is #{d_outer} with an id of: #{d_outer_id} before and: #{d_outer.object_id} after.\n\n"#44 -- 85  -- 89? I'd aspect 85.. so my guess to find a logic has gone!
    ...
    puts "b_inner is #{b_inner} with an id of: #{b_inner_id} inside the block (compared to #{b_outer.object_id} for outer)."#thity three -- 70313124741160 -- 70313124741160
    puts "c_inner is #{c_inner} with an id of: #{c_inner_id} inside the block (compared to #{c_outer.object_id} for outer)."#[44] --  70313124741140 -- 70313124741140
