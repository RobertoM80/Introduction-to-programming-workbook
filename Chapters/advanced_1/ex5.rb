...
#Alyssa supplied Ben with a method called is_a_number? to determine if a string is a number and 
#asked Ben to use it.
...
#You're not returning a false condition, and not handling the case that there are more 
