...
#We learned that when the above "coincidentally" does what we think we wanted "depends" 
#upon what is going on inside the method.

#How can we refactor this exercise to make the result easier to predict and easier for 
